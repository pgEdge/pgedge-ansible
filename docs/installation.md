...
The `make install` command installs the collection for the current user.
...
that uses the pgEdge Ansible Collection:
...
- The [Simple Cluster](simple_cluster.md) guide describes deploying a basic

...
These settings settings define cluster-wide security details. 

### tls_validity_days

- Type: Integer
- Default: 3560
- Description: TLS certificates, keys, signing requests, and other related elements generated by roles in this collection remain valid for this many days. The default is 10 years to avoid cluster operation disruptions due to certificate expiration.

The following example decreases the certificate validity to one year:

```yaml
tls_validity_days: 356
```

...
- **Type:** Integer
- **Default:** `5432`
- **Description:** Port where PostgreSQL listens for connections.
...
- **Description:** Home directory of the `postgres` OS user. Primarily determines defaults of other variables.
    - RHEL: `/var/lib/pgsql`
...
- **Description:** Directory containing PostgreSQL binaries and libraries. Specify for custom installations.
...
- **Description:** PostgreSQL data directory. Specify for custom locations.
...
- **Default:** `[]`
- **Description:** List of user-specified rules for `pg_hba.conf` file. Recognized fields include:

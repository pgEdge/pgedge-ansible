...
- Ability to specify additional HAProxy listeners for specific Patroni node
  types. (EE-9)
...
- Ability to specify multiple database names for subscription management.
  (EE-12)
...
- Renamed db_name role parameter to db_names to list multiple database
  names. (EE-12)
